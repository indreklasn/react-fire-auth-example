...
var JsonProtoSerializer = /** @class */ (function () {
    ...
    JsonProtoSerializer.prototype.fromFieldFilter = function (filter) {
        return new FieldFilter(this.fromFieldPathReference(filter.fieldFilter.field), this.fromOperatorName(filter.fieldFilter.op), this.fromValue(filter.fieldFilter.value));
    };
    // visible for testing
...
var Query$1 = /** @class */ (function () {
    ...
    Query.prototype.where = function (field, opStr, value) {
        ...
        var filter = Filter.create(fieldPath, operator, fieldValue);
