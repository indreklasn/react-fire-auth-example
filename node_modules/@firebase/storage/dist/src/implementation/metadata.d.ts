...
declare class Mapping<T> {
    ...
    constructor(server: string, local?: string | null, writable?: boolean, xform?: ((p1: Metadata, p2: T | undefined) => T | undefined) | null);
}
declare type Mappings = Array<Mapping<unknown>>;
export { Mappings };
